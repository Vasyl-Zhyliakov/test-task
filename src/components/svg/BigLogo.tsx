export default function BigLogo() {
  return (
    <svg
      className="logo-big"
      enable-background="new 0 0 713.6 191.1"
    ...
    >
      ...
      <g>
        <g className="green-text-drop-shadow" filter="url(#filter_S7UVKOWZM)">
          <g clip-path="url(#a)">
            <g
              fill="#fff"
              className="logo-big__line-1"
