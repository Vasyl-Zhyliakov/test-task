...
У рамках тестового завдання було реалізовано прелоадер, стартову секцію сайту і анімовані елементи інтерфейсу, наближені до візуального стилю референсу. Особливу увагу приділено типографіці, рівню деталізації, анімації елементів та загальному стил сторінки.

Замість складної 3D-анімації було використано відео, що забезпечує ефект занурення та візуальну глибину. У рамках обмеженого часу не вдалося реалізувати анімовану взаємодію зі скролом.

# The project was created with React + TypeScript + Vite

[Demo](https://vasyl-zhyliakov.github.io/test-task/)
